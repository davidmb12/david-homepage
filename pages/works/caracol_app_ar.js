...
const Work =() =>{
    return (
        <Layout title="Caracol App">
            <Container>
                <Title title="Works">
                    Caracol App AR <Badge>2021</Badge>
                </Title>
                <P>
                    A fully functional mobile augmented reality app made in Unity, specifically designed and approved by "Caracol Museo de Ciencias", available in Google PlayStore
                </P>
                <List ml={4} my={4}>
                    <ListItem>
                        <Meta> PlayStore</Meta>
                    ...
                    <ListItem>
                        <Meta> Stack</Meta>
                            <span> Unity, ARKit </span>
                    </ListItem>
                </List>
                <WorkImage src="/images/contents/caracolAppAr.png"></WorkImage>
            </Container>
        </Layout>
    )
}
